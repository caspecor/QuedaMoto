...
export function HomepageMap() {
  ...
  return (
    <div className="relative w-full h-full rounded-3xl overflow-hidden border border-white/5 shadow-2xl group">
      ...
      {/* Overlay info */}
      <div className="absolute top-4 right-4 z-[1100] bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10 flex items-center gap-2 pointer-events-none">
